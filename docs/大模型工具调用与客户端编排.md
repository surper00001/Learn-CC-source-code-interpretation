...
更长篇的机制说明（`defer_loading`、`tool_reference`、delta 附件、关键词与 `select:`、`buildSchemaNotSentHint` 等）见 [ToolSearchTool-深度解析.md](./ToolSearchTool-深度解析.md)。
...
| Tool Search 机制长文（排障、delta、discovered set） | [`docs/ToolSearchTool-深度解析.md`](./ToolSearchTool-深度解析.md) |
